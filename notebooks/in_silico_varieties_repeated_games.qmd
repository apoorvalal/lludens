...
data_path = Path("data/repeated_pd_variations_five_models_20260804.jsonl")
...
for ax, treatment in zip(axes, ["sim", "seq", "chat"]):
    ...
    ax.set_xticks(range(len(SHORT_ORDER)), SHORT_ORDER, rotation=40, ha="right")
    ax.set_yticks(range(len(SHORT_ORDER)), SHORT_ORDER)
